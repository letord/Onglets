...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.titre_section0, R.string.titre_section1, R.string.titre_section2 };
    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                icone = mContext.getResources().getDrawable(R.drawable.feuille);
                break;
            case 2:
                titre = mContext.getString(R.string.titre_section2).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.chien);
                break;
        }
